...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-patient-etnia']) &lt;= 1">extension with URL = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-patient-etnia': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-patient-comunidadetnica']) &lt;= 1">extension with URL = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-patient-comunidadetnica': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:identifier/f:type">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-pais']) &gt;= 1">extension with URL = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-pais': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-pais']) &lt;= 1">extension with URL = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-pais': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-address-zonaResidencia']) &lt;= 1">extension with URL = 'https://www.minsalud.gov.co/ihc/fhir/StructureDefinition/co-address-zonaResidencia': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
