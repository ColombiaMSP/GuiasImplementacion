...
* type 1..1 code "representacion de tipo de documento que indexa" ""
* date 1..1 date "Sex" "Sex"
* subject 1..1 code "Nationality" "Nationality"
...
* class 1..1 date "VAR: 18b - Modelidad" "Identificador para determinar la forma en el cual se realiza o entrega la tecnología de salud al usuario en relación con un grupo de servicios - VAR 18b"
